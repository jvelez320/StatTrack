# -*- coding: utf-8 -*-
"""StatTrack Model Maker Object Detection

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/12vCDOWlRH00CdIiq43sW2374JiHaaPln
...
train_data = object_detector.DataLoader.from_pascal_voc('./train', './train', label_map={1:"player",2:"rim",3:"net", 4: "ball"})
validation_data = object_detector.DataLoader.from_pascal_voc('./validate', './validate', label_map={1:"player",2:"rim",3:"net", 4: "ball"})
test_data = object_detector.DataLoader.from_pascal_voc('./test', './test', label_map={1:"player",2:"rim",3:"net", 4: "ball"})
...
!cp /content/test/IMG_1445_002.jpg .

TEMP_FILE = '/content/test/IMG_1445_002.jpg'

# !wget -q -O $TEMP_FILE $INPUT_IMAGE_URL
im = Image.open('/content/test/IMG-1740.jpg')
